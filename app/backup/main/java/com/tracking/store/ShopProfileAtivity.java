...
public class ShopProfileAtivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String nextScheduleDate = utilInstance.getDateToString(storeInfo.NextScheduledVisit);

        txtNextScheduleVisit.setText(nextScheduleDate);
        ...
        try{
            if(!storeInfo.IsSync){
                ...
                if(file.exists()){
                    Picasso.with(ShopProfileAtivity.this).load(file).placeholder(R.mipmap.ic_loading).into(imageView);
                }
            }
        }catch (Exception e){
            e.printStackTrace();
        ...
        try{
            ...
            if(!storeInfo.ImgUrl.equals("") && !storeInfo.ImgUrl.equals("null")){
                ...
                Picasso.with(ShopProfileAtivity.this).load(url).placeholder(R.mipmap.ic_loading).into(imageView);
            }
