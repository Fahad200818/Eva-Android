...
import com.tracking.store.adapter.CompetitiveAdapter;
...
import com.tracking.store.view.CompitativeTakingDialog;
...
public class CompitativeStockFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        textViewTitle.setText("Competitor Inventory");
    ...
    public void postCompitativeTaken(JSONObject jsonObject, final ArrayList<Stocks> orderItems) {
        ...
        httpCaller.jsonObjectPOSTRequest(true, getActivity(), url, jsonObject, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(com.android.volley.VolleyError error) {
                Toast.makeText(getActivity(), "All competative stocks Added failed", Toast.LENGTH_SHORT).show();
    ...
    public void refreshCompitativeList(final ArrayList<Stocks> orderItems, boolean isInternetConnect){
        ...
        for (Stocks stock : orderItems) {
            /*CompetitiveItem competitiveItem = new CompetitiveItem();
            competitiveItem.CompetitiveID = utilInstance.getUniqueID();
            competitiveItem.StoreVisitID = storeVisit.StoreVisitID;
            competitiveItem.StoreID = ""+store.StoreID;
            competitiveItem.Product = stocks.Product;
            competitiveItem.Qty = stocks.Qty;
            competitiveItem.IsSync =isInternetConnect;
            competitiveItem.save();
            competitiveItemList.add(competitiveItem);*/
        ...
        Toast.makeText(getActivity(), "All competative stocks Successfully Added", Toast.LENGTH_SHORT).show();
